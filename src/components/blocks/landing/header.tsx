...
import { SignUser } from '@/components/blocks/auth';
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
} from '@/components/compound/navigation-menu';
  ...
  return (
    <>
      ...
      >
        <div
          className={cn(
            'absolute inset-x-0 top-0 z-50 h-18 border-transparent ring-1 ring-transparent transition-[height,background-color,border-color,backdrop-filter] duration-300',
